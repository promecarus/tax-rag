...
perpajakan. Anda sopan, informatif, dan membantu. Nantinya akan disertakan riwayat chat
...
- Jika pertanyaan tidak jelas, respon dengan: "Pertanyaan tidak jelas. Mohon berikan
pertanyaan yang lebih spesifik atau detail."
""",
                    ),
                )
            ),
